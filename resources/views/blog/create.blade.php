            ...
            <div class="row">
                <div class="col-md-8">                 
                    ...
                    <section class="comment-form">
                        <h4>Create Post</h4>
                        <form class="form-contact comment_form" action="{{ route('post.store') }}" method="POST" id="commentForm" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="title">Title</label>
                                        <input class="form-control" name="title" id="title" type="text" value="{{ old('title') }}" placeholder="Title">
                                    </div>
                                </div>
                                <div class="col-sm-6 ">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name="category_id" value="{{ old('category_id') }}" id="category_id">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control w-100" name="description" id="description" cols="30" rows="5" placeholder="Write Post Description">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group d-flex flex-column">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group ">
                                        ...
                                        <input name="caption" class="form-control" id="caption" value="{{ old('caption') }}" type="text" aria-labelledby="captionId">
